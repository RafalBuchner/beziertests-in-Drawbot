...
class bezier(object):
    ...
    def calcActual_t(self):
        T = self.D
        t = (2*self.P1.x + self.P2.x + self.P4.x) / T.x
        return t
...
t = Curve.calcActual_t()
print "this is actual_t: %f\nthis is        t: %f" % (t,Curve.actual_t)
